...
export default function Wiredheadphones2() {
                ...
                <div className='container-fixed d-flex col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12  my-5'>
                    <div>
                        <div className='my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM1300_main_4_600x.png?v=1632715015' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM1300-FI_Blue02_72x.png?v=1659425496' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM1300-FI_Blue03_72x.png?v=1659425496' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM1300-FI_Blue04_72x.png?v=1659425496' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM1300-FI_Blue05_72x.png?v=1659425496' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                    ...
                    <div className='container-fluid d-flex flex-wrap mx-2' style={{ border: "1px solid lightgrey", backgroundColor: "lightgray", borderRadius: "10px" }} >
                        <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM1300_main_4_600x.png?v=1632715015' className='img-fluid' />
                    </div>
                </div>
                            ...
                            return (<div>
                                <div className='mx-3'>
                                    <div className='d-flex'>
                                        ...
                                        <p className='my-4 ' style={{ fontSize: "15px" }}>{value.category67}</p>
                                        <p className='my-4 mx-1' style={{ fontSize: "15px" }}>{value.category68}</p>
                                        <VerifiedIcon className='my-4 ' style={{ width: "15px", color: "green" }}></VerifiedIcon>
                                    </div>
                                    <h5 className='fs-2 mb-2'>{value.category69}</h5>
                                    <p style={{ fontSize: "13px" }}>Wireless Earbuds with upto 60 Hours playback, 13mm Drivers, IWP Technology, 650mAh Charging Case</p>
                                    <p className='fs-4' style={{ fontSize: "20px", }}>{value.category70}<span className='fs-6 mx-1' style={{ textDecoration: "line-through" }}>{value.category71} </span> <span style={{color:"green"}}>{value.category72} </span></p>

                                    <h5 className='fs-6'>{value.category73}</h5>
                                    ...
                                    <a className='btn2 btn btn-primary bg-blue py-2'>{value.category74}</a>
