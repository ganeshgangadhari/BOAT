                ...
                <div className='container-fixed d-flex col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12  my-5'>
                    <div>
                        <div className='my-2 mx-5'>
                            <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/products/103b_72x.png?v=1574927262' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/files/bassheads-103-blue-boat-original-imafyz3wtfubwzdr_72x.webp?v=1686211516' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/files/bassheads-103-blue-boat-original-imafyz3wzdggy9hz_72x.webp?v=1686211517' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/files/bassheads-103-blue-boat-original-imafyz3wwbuwzyzs_72x.webp?v=1686211517' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/files/bassheads-103-blue-boat-original-imafyz3wbqfpn45h_72x.webp?v=1686211516' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                    ...
                    <div className='container-fluid d-flex flex-wrap mx-2' style={{ border: "1px solid lightgrey", backgroundColor: "lightgray", borderRadius: "10px" }} >
                        <img src='https://cdn.shopify.com/s/files/1/0057/8938/4802/products/103b_600x.png?v=1574927262' className='img-fluid' />
                    </div>
                </div>
                            ...
                            return (<div>
                                <div className='mx-3'>
                                    <div className='d-flex'>
                                        ...
                                        <p className='my-4 ' style={{ fontSize: "15px" }}>{value.category91}</p>
                                        <p className='my-4 mx-1' style={{ fontSize: "15px" }}>{value.category92}</p>
                                        <VerifiedIcon className='my-4 ' style={{ width: "15px", color: "green" }}></VerifiedIcon>
                                    </div>
                                    <h5 className='fs-2 mb-2'>{value.category93}</h5>
                                    <p style={{ fontSize: "13px" }}>Wireless Earbuds with upto 60 Hours playback, 13mm Drivers, IWP Technology, 650mAh Charging Case</p>
                                    <p className='fs-4' style={{ fontSize: "20px", }}>{value.category94}<span className='fs-6 mx-1' style={{ textDecoration: "line-through" }}>{value.category95} </span> <span style={{color:"green"}}>{value.category96} </span></p>

                                    <h5 className='fs-6'>{value.category97}</h5>
                                    ...
                                    <a className='btn2 btn btn-primary bg-blue py-2'>{value.category98}</a>
