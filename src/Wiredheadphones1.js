...
export default function Wiredheadphones1() {
                ...
                <div className='container-fixed d-flex col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12  my-5'>
                    <div>
                        <div className='my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/main-700_72x.png?v=1643632678' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/main2-700_72x.png?v=1643632679' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM400-FI02_72x.png?v=1659425849' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM400-FI03_72x.png?v=1659425848' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                        <div className=' my-2 mx-5'>
                            <img src='https://www.boat-lifestyle.com/cdn/shop/products/IM400-FI04_72x.png?v=1659425849' alt='' style={{ height: "65px", border: "0.1rem solid lightgrey", borderRadius: "8px" }} />
                        </div>
                    ...
                    <div className='container-fluid d-flex flex-wrap mx-2' style={{ border: "1px solid lightgrey", backgroundColor: "lightgray", borderRadius: "10px" }} >
                        <img src='https://www.boat-lifestyle.com/cdn/shop/products/main-700_600x.png?v=1643632678' className='img-fluid' />
                    </div>
                </div>
                            ...
                            return (<div>
                                <div className='mx-3'>
                                    <div className='d-flex'>
                                        ...
                                        <p className='my-4 ' style={{ fontSize: "15px" }}>{value.category59}</p>
                                        <p className='my-4 mx-1' style={{ fontSize: "15px" }}>{value.category60}</p>
                                        <VerifiedIcon className='my-4 ' style={{ width: "15px", color: "green" }}></VerifiedIcon>
                                    </div>
                                    <h5 className='fs-2 mb-2'>{value.category61}</h5>
                                    <p style={{ fontSize: "13px" }}>Wireless Earbuds with upto 60 Hours playback, 13mm Drivers, IWP Technology, 650mAh Charging Case</p>
                                    <p className='fs-4' style={{ fontSize: "20px", }}>{value.category62}<span className='fs-6 mx-1' style={{ textDecoration: "line-through" }}>{value.category63} </span> <span style={{color:"green"}}>{value.category64} </span></p>

                                    <h5 className='fs-6'>{value.category65}</h5>
                                    ...
                                    <a className='btn2 btn btn-primary bg-blue py-2'>{value.category66}</a>
